...
## Crowd simulation
### How to use it
Drag the crowd sim blueprint in the screen. You will see a man on the screen. If we want to longer the crowd line: click the white ball while press Alt, drag the line and there will be more people shown on the screen. You can adjust the parameters through the right-side parameter panel by selecting the spline (or select one of the model).  
![image](https://github.com/1COASTLINE1/Blueprints_code/blob/main/Screen%20shot/7.png)
